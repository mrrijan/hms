...
<template>
    <el-row>
        ...
        <el-col :span="6">
            <el-input size="small" keyup.enter="searchCustomers" :prefix-icon="Search" placeholder="search"
                      v-model="searchTerm" clearable/>
        </el-col>
    </el-row>
    <el-table v-loading="paymentsLoading" :data="payments" border>
        <el-table-column prop="customer_name" label="Customer"/>
        <el-table-column prop="total_amount" label="Total Amount"/>
        <el-table-column prop="advance_payment" label="Advance Payment" width="150"/>
